.class Lcom/facebook/react/uimanager/s0;
...
.method static a(Lcom/facebook/react/uimanager/UIManagerModule$g;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {}, Lcom/facebook/react/uimanager/r0;->b()Ljava/util/Map;

    move-result-object v0

    .line 2
    invoke-interface {p0}, Lcom/facebook/react/uimanager/UIManagerModule$g;->b()Ljava/util/List;
...
.method static b(Ljava/util/List;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    invoke-static {}, Lcom/facebook/react/uimanager/r0;->a()Ljava/util/Map;
    ...
    .line 12
    :try_start_0
    invoke-static {v3, v7, v7, p1, p2}, Lcom/facebook/react/uimanager/s0;->c(Lcom/facebook/react/uimanager/ViewManager;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
...
.method static c(Lcom/facebook/react/uimanager/ViewManager;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 3
    invoke-static {p3, v1}, Lcom/facebook/react/uimanager/s0;->e(Ljava/util/Map;Ljava/util/Map;)V

    .line 4
    invoke-static {v1, p1}, Lcom/facebook/react/uimanager/s0;->e(Ljava/util/Map;Ljava/util/Map;)V
    ...
    .line 8
    invoke-static {p4, p1}, Lcom/facebook/react/uimanager/s0;->e(Ljava/util/Map;Ljava/util/Map;)V

    .line 9
    invoke-static {p1, p2}, Lcom/facebook/react/uimanager/s0;->e(Ljava/util/Map;Ljava/util/Map;)V
...
.method private static e(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-static {v3, v2}, Lcom/facebook/react/uimanager/s0;->e(Ljava/util/Map;Ljava/util/Map;)V
