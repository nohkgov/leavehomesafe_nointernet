...
.method public static key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, Ll/f;->r(Ljava/lang/String;)Ll/f;

    move-result-object p0

    invoke-virtual {p0}, Ll/f;->v()Ll/f;
...
.method static readInt(Ll/e;)I
    ...
    .line 1
    :try_start_0
    invoke-interface {p0}, Ll/e;->Q()J

    move-result-wide v0

    .line 2
    invoke-interface {p0}, Ll/e;->A()Ljava/lang/String;
...
.method get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Ll/t;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Ll/t;)V
    :try_end_1
