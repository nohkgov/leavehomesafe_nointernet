...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    .line 11
    invoke-static {p1}, Ll/f;->y([B)Ll/f;

    move-result-object p1

    invoke-virtual {p1}, Ll/f;->b()Ljava/lang/String;
...
.method private declared-synchronized send(Ll/f;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILl/f;)V
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    .line 3
    invoke-static {p2}, Ll/f;->r(Ljava/lang/String;)Ll/f;
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILl/f;J)V
...
.method public connect(Lokhttp3/OkHttpClient;)V
    ...
    .line 12
    invoke-interface {p1}, Lokhttp3/Call;->timeout()Ll/u;

    move-result-object p1

    invoke-virtual {p1}, Ll/u;->clearTimeout()Ll/u;
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Ll/d;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLl/d;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Ll/e;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLl/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Ll/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Ll/f;)V

    return-void
.end method

.method public declared-synchronized onReadPing(Ll/f;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Ll/f;)V
    .locals 0
...
.method declared-synchronized pong(Ll/f;)Z
    .locals 1
...
.method public send(Ljava/lang/String;)Z
    ...
    .line 1
    invoke-static {p1}, Ll/f;->r(Ljava/lang/String;)Ll/f;

    move-result-object p1

    const/4 v0, 0x1

    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Ll/f;I)Z
...
.method writeOneFrame()Z
    ...
    .line 16
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Ll/f;)V
    ...
    iget-object v2, v2, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Ll/f;
    ...
    .line 21
    invoke-virtual {v0, v3, v4, v5}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Ll/s;
    ...
    .line 22
    invoke-interface {v0, v2}, Ll/d;->L(Ll/f;)Ll/d;
    ...
    iget-object v4, v4, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Ll/f;

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILl/f;)V
...
.method writePingFrame()V
    ...
    :cond_2
    :try_start_1
    sget-object v1, Ll/f;->f:Ll/f;

    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Ll/f;)V
    :try_end_1
