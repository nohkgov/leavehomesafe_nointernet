...
.field private final source:Ll/e;
...
.method constructor <init>(Ll/e;Z)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ll/e;
    ...
    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Ll/e;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILl/t;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ll/e;
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ll/e;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILl/e;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ll/e;

    int-to-long p2, v0

    invoke-interface {p1, p2, p3}, Ll/e;->e(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ll/e;

    invoke-interface {p4}, Ll/e;->readInt()I

    move-result p4

    .line 2
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ll/e;

    invoke-interface {v2}, Ll/e;->readInt()I
    ...
    invoke-interface {p3, v1, v2}, Ll/e;->m(J)Ll/f;

    move-result-object p3

    .line 6
    :cond_0
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Ll/f;)V
...
.method static readMedium(Ll/e;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-interface {p0}, Ll/e;->readByte()B
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ll/e;

    invoke-interface {p2}, Ll/e;->readInt()I
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    invoke-interface {v0}, Ll/e;->readInt()I
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ll/e;

    invoke-interface {v3}, Ll/e;->readByte()B
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ll/e;

    invoke-interface {v1}, Ll/e;->readInt()I
...
.method private readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {v2}, Ll/e;->readShort()S
    ...
    invoke-interface {v3}, Ll/e;->readInt()I
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Ll/e;->a0(J)V
    :try_end_0
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Ll/e;)I
    ...
    invoke-interface {p1}, Ll/e;->readByte()B
    ...
    invoke-interface {p1, v0, v1}, Ll/e;->e(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Ll/f;
    ...
    invoke-interface {p1, v3, v4}, Ll/e;->m(J)Ll/f;
