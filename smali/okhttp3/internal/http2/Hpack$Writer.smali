...
# direct methods
.method constructor <init>(IZLl/c;)V
    .locals 1
    ...
    .line 11
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Ll/c;
...
.method constructor <init>(Ll/c;)V
    ...
    .line 1
    invoke-direct {p0, v0, v1, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLl/c;)V
...
.method writeByteString(Ll/f;)V
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Ll/f;)I
    ...
    invoke-virtual {v2, p1, v0}, Lokhttp3/internal/http2/Huffman;->encode(Ll/f;Ll/d;)V
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Ll/c;
...
.method writeHeaders(Ljava/util/List;)V
    ...
    .line 9
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Ll/f;

    invoke-virtual {v4}, Ll/f;->Q()Ll/f;

    move-result-object v4

    .line 10
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Ll/f;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:Ll/f;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Ll/f;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Ll/f;
    ...
    .line 21
    iget-object v7, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Ll/c;

    invoke-virtual {v7, v6}, Ll/c;->B0(I)Ll/c;

    .line 22
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Ll/f;)V

    .line 23
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Ll/f;)V
    ...
    .line 25
    :cond_9
    sget-object v7, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Ll/f;

    invoke-virtual {v4, v7}, Ll/f;->N(Ll/f;)Z

    move-result v7

    if-eqz v7, :cond_a

    sget-object v7, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Ll/f;
...
.method writeInt(III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Ll/c;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, Ll/c;->B0(I)Ll/c;
    ...
    invoke-virtual {v0, p3}, Ll/c;->B0(I)Ll/c;
    ...
    invoke-virtual {v0, p2}, Ll/c;->B0(I)Ll/c;
