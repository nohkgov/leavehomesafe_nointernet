...
.field private sink:Ll/d;

.field private socket:Ljava/net/Socket;

.field private source:Ll/e;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {p1}, Ll/l;->m(Ljava/net/Socket;)Ll/t;

    move-result-object p1

    invoke-static {p1}, Ll/l;->d(Ll/t;)Ll/e;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Ll/e;

    .line 11
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    invoke-static {p1}, Ll/l;->i(Ljava/net/Socket;)Ll/s;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ll/d;
    :try_end_1
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 21
    invoke-static {v1}, Ll/l;->m(Ljava/net/Socket;)Ll/t;
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ll/d;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Ll/e;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Ll/e;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ll/d;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Ll/e;Ll/d;)V
    ...
    invoke-virtual {v1, v4, v5, v2}, Ll/u;->timeout(JLjava/util/concurrent/TimeUnit;)Ll/u;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ll/d;
    ...
    .line 11
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Ll/t;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Ll/t;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 20
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Ll/e;
    ...
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ll/d;
...
.method private startHttp2(I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Ll/e;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ll/d;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Ll/e;Ll/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 28
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Ll/e;

    .line 29
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Ll/d;
...
.method public isHealthy(Z)Z
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Ll/e;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v0, v1, v2, v3}, Ll/u;->timeout(JLjava/util/concurrent/TimeUnit;)Ll/u;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Ll/d;
    ...
    invoke-virtual {v0, v1, v2, p2}, Ll/u;->timeout(JLjava/util/concurrent/TimeUnit;)Ll/u;
    ...
    invoke-direct {p2, p1, p3, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Ll/e;Ll/d;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLl/e;Ll/d;Lokhttp3/internal/connection/StreamAllocation;)V
