...
.method private newJournalWriter()Ll/d;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Ll/s;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ll/s;)V

    .line 3
    invoke-static {v1}, Ll/l;->c(Ll/s;)Ll/d;
...
.method private readJournal()V
    ...
    invoke-interface {v1, v2}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Ll/t;
    ...
    .line 2
    :try_start_0
    invoke-interface {v1}, Ll/e;->A()Ljava/lang/String;
    ...
    .line 16
    :cond_0
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Ll/d;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Ll/d;
    :try_end_2
...
.method public declared-synchronized close()V
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Ll/d;
...
.method declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 25
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Ll/d;

    const-string v1, "CLEAN"

    invoke-interface {p1, v1}, Ll/d;->b0(Ljava/lang/String;)Ll/d;

    move-result-object p1

    invoke-interface {p1, v3}, Ll/d;->F(I)Ll/d;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Ll/d;)V

    .line 28
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Ll/d;

    invoke-interface {p1, v2}, Ll/d;->F(I)Ll/d;
    ...
    invoke-interface {p1, p2}, Ll/d;->b0(Ljava/lang/String;)Ll/d;
...
.method declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 11
    :cond_3
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Ll/d;

    const-string p3, "DIRTY"

    invoke-interface {p2, p3}, Ll/d;->b0(Ljava/lang/String;)Ll/d;

    move-result-object p2

    const/16 p3, 0x20

    invoke-interface {p2, p3}, Ll/d;->F(I)Ll/d;

    move-result-object p2

    invoke-interface {p2, p1}, Ll/d;->b0(Ljava/lang/String;)Ll/d;
    ...
    invoke-interface {p2}, Ll/d;->flush()V
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 9
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Ll/d;

    const-string v2, "READ"

    invoke-interface {v1, v2}, Ll/d;->b0(Ljava/lang/String;)Ll/d;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, Ll/d;->F(I)Ll/d;

    move-result-object v1

    invoke-interface {v1, p1}, Ll/d;->b0(Ljava/lang/String;)Ll/d;

    move-result-object p1

    const/16 v1, 0xa

    invoke-interface {p1, v1}, Ll/d;->F(I)Ll/d;
...
.method declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Ll/s;
    ...
    .line 4
    invoke-interface {v0, v1}, Ll/d;->b0(Ljava/lang/String;)Ll/d;
    ...
    invoke-interface {v0, v3, v4}, Ll/d;->c0(J)Ll/d;
    ...
    .line 8
    invoke-interface {v0, v2}, Ll/d;->F(I)Ll/d;
    ...
    .line 11
    invoke-interface {v0, v4}, Ll/d;->b0(Ljava/lang/String;)Ll/d;

    move-result-object v4

    invoke-interface {v4, v5}, Ll/d;->F(I)Ll/d;

    .line 12
    iget-object v3, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-interface {v0, v3}, Ll/d;->b0(Ljava/lang/String;)Ll/d;
    ...
    .line 16
    invoke-virtual {v3, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Ll/d;)V
...
.method removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v2}, Ll/d;->b0(Ljava/lang/String;)Ll/d;
