...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Ll/t;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Ll/t;[J)V
    :try_end_0
...
.method writeLengths(Ll/d;)V
    ...
    .line 2
    invoke-interface {p1, v5}, Ll/d;->F(I)Ll/d;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Ll/d;->c0(J)Ll/d;
