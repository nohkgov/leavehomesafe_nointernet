...
.field final synthetic val$cacheBody:Ll/d;

.field final synthetic val$cacheRequest:Lokhttp3/internal/cache/CacheRequest;

.field final synthetic val$source:Ll/e;


# direct methods
.method constructor <init>(Lokhttp3/internal/cache/CacheInterceptor;Ll/e;Lokhttp3/internal/cache/CacheRequest;Ll/d;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lokhttp3/internal/cache/CacheInterceptor$1;->this$0:Lokhttp3/internal/cache/CacheInterceptor;

    iput-object p2, p0, Lokhttp3/internal/cache/CacheInterceptor$1;->val$source:Ll/e;

    iput-object p3, p0, Lokhttp3/internal/cache/CacheInterceptor$1;->val$cacheRequest:Lokhttp3/internal/cache/CacheRequest;

    iput-object p4, p0, Lokhttp3/internal/cache/CacheInterceptor$1;->val$cacheBody:Ll/d;
...
.method public close()V
    ...
    .line 2
    invoke-static {p0, v0, v1}, Lokhttp3/internal/Util;->discard(Ll/t;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 5
    :cond_0
    iget-object v0, p0, Lokhttp3/internal/cache/CacheInterceptor$1;->val$source:Ll/e;
...
.method public read(Ll/c;J)J
    ...
    .line 1
    :try_start_0
    iget-object v1, p0, Lokhttp3/internal/cache/CacheInterceptor$1;->val$source:Ll/e;

    invoke-interface {v1, p1, p2, p3}, Ll/t;->read(Ll/c;J)J
    ...
    .line 4
    iget-object p1, p0, Lokhttp3/internal/cache/CacheInterceptor$1;->val$cacheBody:Ll/d;
    ...
    .line 5
    :cond_1
    iget-object v0, p0, Lokhttp3/internal/cache/CacheInterceptor$1;->val$cacheBody:Ll/d;

    invoke-interface {v0}, Ll/d;->d()Ll/c;
    ...
    invoke-virtual/range {v2 .. v7}, Ll/c;->u(Ll/c;JJ)Ll/c;

    .line 6
    iget-object p1, p0, Lokhttp3/internal/cache/CacheInterceptor$1;->val$cacheBody:Ll/d;

    invoke-interface {p1}, Ll/d;->P()Ll/d;
