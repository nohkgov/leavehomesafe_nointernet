...
.method private buildCall()Lokhttp3/Call;
    ...
    .line 19
    :goto_3
    invoke-virtual {v0}, Lokhttp3/internal/huc/OutputStreamRequestBody;->timeout()Ll/u;
    ...
    invoke-virtual {v1, v3, v4, v5}, Ll/u;->timeout(JLjava/util/concurrent/TimeUnit;)Ll/u;
...
.method private static toHumanReadableAscii(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {v6, p0, v1, v2}, Ll/c;->K0(Ljava/lang/String;II)Ll/c;

    const/16 v1, 0x3f

    .line 6
    invoke-virtual {v6, v1}, Ll/c;->L0(I)Ll/c;
    ...
    .line 9
    :goto_2
    invoke-virtual {v6, v7}, Ll/c;->L0(I)Ll/c;

    goto :goto_1

    .line 10
    :cond_2
    invoke-virtual {v6}, Ll/c;->r0()Ljava/lang/String;
