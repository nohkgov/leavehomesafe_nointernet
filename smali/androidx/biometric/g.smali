...
.method a()V
    ...
    .line 5
    :cond_0
    iget-object v0, p0, Landroidx/biometric/g;->c:Ld/g/i/a;

    if-eqz v0, :cond_1

    .line 6
    :try_start_1
    invoke-virtual {v0}, Ld/g/i/a;->a()V
    :try_end_1
    ...
    .line 8
    :goto_1
    iput-object v1, p0, Landroidx/biometric/g;->c:Ld/g/i/a;
...
.method c()Ld/g/i/a;
    ...
    invoke-interface {v0}, Landroidx/biometric/g$c;->b()Ld/g/i/a;

    move-result-object v0

    iput-object v0, p0, Landroidx/biometric/g;->c:Ld/g/i/a;
