...
# direct methods
.method static a(Landroid/view/View;Ld/s/d0;IIFFFFLandroid/animation/TimeInterpolator;Ld/s/x;)Landroid/animation/Animator;
    .locals 14
    ...
    .line 3
    iget-object v4, v1, Ld/s/d0;->b:Landroid/view/View;

    sget v5, Ld/s/s;->transition_position:I
    ...
    .line 14
    new-instance v5, Ld/s/f0$a;

    iget-object v1, v1, Ld/s/d0;->b:Landroid/view/View;
    ...
    invoke-direct/range {p1 .. p7}, Ld/s/f0$a;-><init>(Landroid/view/View;Landroid/view/View;IIFF)V

    move-object/from16 v0, p9

    .line 15
    invoke-virtual {v0, v5}, Ld/s/x;->b(Ld/s/x$f;)Ld/s/x;

    .line 16
    invoke-virtual {v4, v5}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 17
    invoke-static {v4, v5}, Ld/s/a;->a(Landroid/animation/Animator;Landroid/animation/AnimatorListenerAdapter;)V
